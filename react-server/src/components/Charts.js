...
export default function Charts(props) {
  ...
  //    ##EDFViewer: height="120%"
  //  #Chart gradient
  //    ##Dashboard: ctx.createLinearGradient(0, 0, 0, 400);
  //    ##EDFViewer: ctx.createLinearGradient(0, 0, 0, 400);
  return (
    <React.Fragment>
      <Box>
        {/* Hypnogram */}
        {/* <Line height="20%" options={sleepCycleOptions} data={sleepCycleData} />
        <br></br> */}
        {/* Charts */}
        {charts.map((row) => (
